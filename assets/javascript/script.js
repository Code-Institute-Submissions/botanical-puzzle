...
var plants = [
        ...
        {
            'name': 'Aurum Lilly',
            'description': 'Found in shady places. Arrow-shaped glossy leaves, with shiny orange berries in late summer. Poisonous.',
            'image_name': 'aurumlilly.png',
            'coords': '1071,609,1166,759',
        },
        {
            'name': 'Balm',
            'description': 'Found near hedges in shady places. Yellow-green pointed leaves, white/yellow flowers July-Sept. Lemon-scented leaves.',
            'image_name': 'balm.png',
        ...
        {
            'name': 'Bilberry',
            'description': 'A low shrub (20-50cm), usually found on heaths and moors. The flowers are drooping and green-pink, the berries similar to blueberries, July-Sept.',
            'image_name': 'bilberry.png',
            'coords': '778,41,923,327',
        },
        {
            'name': 'Bistort',
            'description': 'Also known as dock, found in mid and northern parts of British Isles, arrow-shaped leaves and spikes of pink flowers; grows to about 60cm.',
